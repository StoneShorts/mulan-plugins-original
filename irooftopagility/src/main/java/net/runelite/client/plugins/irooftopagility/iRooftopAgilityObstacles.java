...
public enum iRooftopAgilityObstacles {
    //TREE GNOME
    GNOME_LOG(new WorldPoint(2470, 3435, 0), new WorldPoint(2489, 3447, 0), LOG_BALANCE_23145, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    GNOME_ROPE(new WorldPoint(2469, 3416, 2), new WorldPoint(2479, 3423, 2), BALANCING_ROPE_23557, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    //DRAYNOR
    DRAY_WALL(new WorldPoint(3082, 3238, 0), new WorldPoint(3105, 3293, 0), ROUGH_WALL, iRooftopAgilityObstacleType.DECORATION, BANK_BOOTH_10355),
    DRAY_TIGHTROPE(new WorldPoint(3096, 3275, 3), new WorldPoint(3103, 3282, 3), TIGHTROPE, iRooftopAgilityObstacleType.GROUND_OBJECT),
    DRAY_TIGHTROPE_TWO(new WorldPoint(3086, 3271, 3), new WorldPoint(3093, 3279, 3), TIGHTROPE_11406, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    //ALKHARID
    ALK_ROUGHWALL(new WorldPoint(3268, 3159, 0), new WorldPoint(3322, 3200, 0), ROUGH_WALL_11633, iRooftopAgilityObstacleType.DECORATION),
    ALK_TIGHTROPE(new WorldPoint(3270, 3179, 3), new WorldPoint(3278, 3193, 3), TIGHTROPE_14398, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    ALK_ROOF_TOP_BEAMS(new WorldPoint(3311, 3172, 2), new WorldPoint(3319, 3180, 2), ROOF_TOP_BEAMS, iRooftopAgilityObstacleType.DECORATION),
    ALK_TIGHTROPE_TWO(new WorldPoint(3311, 3180, 3), new WorldPoint(3319, 3187, 3), TIGHTROPE_14409, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ALK_GAP(new WorldPoint(3296, 3184, 3), new WorldPoint(3306, 3194, 3), GAP_14399),
    //VARROCK
    COURSE_GROUND(new WorldPoint(3184, 3386, 0), new WorldPoint(3258, 3428, 0), ROUGH_WALL_14412, iRooftopAgilityObstacleType.DECORATION, ObjectID.BANK_BOOTH_10583),
    ...
    FAL_ROOFTOP_ONE(new WorldPoint(3034, 3342, 3), new WorldPoint(3040, 3347, 3), TIGHTROPE_14899, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    FAL_ROOFTOP_SIX(new WorldPoint(3025, 3352, 3), new WorldPoint(3029, 3355, 3), TIGHTROPE_14911, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    //SEERS
    SEERS_GROUND(new WorldPoint(2689, 3457, 0), new WorldPoint(2750, 3517, 0), WALL_14927, iRooftopAgilityObstacleType.DECORATION, BANK_BOOTH_25808),
    SEERS_ROOF_ONE(new WorldPoint(2720, 3489, 3), new WorldPoint(2731, 3498, 3), GAP_14928),
    SEERS_ROOF_TWO(new WorldPoint(2702, 3486, 2), new WorldPoint(2714, 3499, 2), TIGHTROPE_14932, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    POLL_ROOF_FIVE(new WorldPoint(3365, 2982, 1), new WorldPoint(3370, 2987, 1), ROUGH_WALL_14940, iRooftopAgilityObstacleType.DECORATION),
    ...
    //Rellekka
    RELL_GROUND(new WorldPoint(2612, 3654, 0), new WorldPoint(2672, 3687, 0), ROUGH_WALL_14946, iRooftopAgilityObstacleType.DECORATION),
    ...
    //Ardougne
    ARDY_GROUND(new WorldPoint(2640, 3274, 0), new WorldPoint(2678, 3321, 0), WOODEN_BEAMS, iRooftopAgilityObstacleType.DECORATION, ObjectID.BANK_BOOTH_10355),
    ARDY_GAP(new WorldPoint(2670, 3298, 3), new WorldPoint(2675, 3312, 3), GAP_15609),
    ARDY_BEAM(new WorldPoint(2660, 3317, 3), new WorldPoint(2666, 3323, 3), PLANK_26635, iRooftopAgilityObstacleType.GROUND_OBJECT),
    ...
    @Getter(AccessLevel.PACKAGE)
    private iRooftopAgilityObstacleType type = iRooftopAgilityObstacleType.NORMAL;

    @Getter(AccessLevel.PACKAGE)
    private int bankID = 0;

    iRooftopAgilityObstacles(final WorldPoint min, final WorldPoint max, final int obstacleId) {
        this.location = new WorldArea(min, max);
        this.obstacleId = obstacleId;
    }

    iRooftopAgilityObstacles(final WorldPoint min, final WorldPoint max, final int obstacleId, final int bankID) {
        this.location = new WorldArea(min, max);
        this.obstacleId = obstacleId;
        this.bankID = bankID;
    }

    iRooftopAgilityObstacles(final WorldPoint min, final WorldPoint max, final int obstacleId, final iRooftopAgilityObstacleType type) {
        this.location = new WorldArea(min, max);
        this.obstacleId = obstacleId;
        this.type = type;
    }

    iRooftopAgilityObstacles(final WorldPoint min, final WorldPoint max, final int obstacleId, final iRooftopAgilityObstacleType type, final int bankID) {
        this.location = new WorldArea(min, max);
        this.obstacleId = obstacleId;
        this.type = type;
        this.bankID = bankID;
    ...
    public iRooftopAgilityObstacleType getObstacleType() {
        return type;
    }

    public static iRooftopAgilityObstacles getObstacle(WorldPoint worldPoint) {
        for (iRooftopAgilityObstacles obstacle : values()) {
